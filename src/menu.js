...
function createMenuButtons()
{
	...
	addMenuButton("Music on", 250, m.optionsButtons, "boolean", {defaultValue: o.music});
...
function addMenuButton(buttonName, buttonY, locationArray, buttonType, buttonParameters) // buttonParameters is an object, yo!
{
	var tempObj = {};
...
function displayGameWon(layer)
{
	...
	layer.fillStyle = c.mainMenuColor;
	layer.drawCenteredString("YOU WON", c.hCanWidth, 200);
	layer.drawCenteredString("SCORE: " + ga.score, c.hCanWidth, 250);
	
	handleMenuButtons(layer, m.gameWonButtons);
}
