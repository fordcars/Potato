...
function definitions() // Has access to other functions, since this is after function definitions.
{
	...
	r.resourceConstructors = [
		{type: "audio", name: "potatoMusic", path: "potato.wav"},
...
{
	ga.gamejoltUsername = prompt("To receive trophies, please enter your username: ", "Username");
	
	if(ga.gamejoltUsername==null || ga.gamejoltUsername==undefined)
	{
		alert("You will not be able to receive trophies. Reload the page if you change your mind :)");
	} else
	{
		ga.gamejoltUserToken = prompt("Again, to receive trophies, please enter your user token: ", "User token");
