...
function loadResources(resourcesArray) // Works because objects in javascript are passed by reference!
{
	...
	for(var i=0; i<c.numberOfResources; i++)
	{
		...
		if(currentResource.type=="audio")
		{
			currentResourceData.autoplay = true;
			currentResourceData.loop = true;
			currentResourceData.addEventListener("canplaythrough", function(){resourceLoaded();}, false);
		} else
		{
